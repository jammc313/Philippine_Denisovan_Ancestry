...
# The model we are testing is ALT3B, with an admixture event from Neanderthal into the shared ancestor of all Non-Africans, a Denisovan admixture event private into Papuans, and another private Denisovan admixture into Ayta. The difference between this and model ALT2 are the relative timings of private events into Papuan and Ayta. The difference from model ALT3 is that here includes a recent admixture event from East Asians to Ayta.
...
def set_up_demography(t78, t68, t85, t54, t10, t20, t03, t93, t34, t410, ta1, ta2, ta3, ta4, f):
    ...
    admix = [msp.MassMigration(time=ta1, source=AYT, destination=DEN2, proportion=f[1]), #fraction from Denisovan 2 to Ayta
            ...
            msp.MassMigration(time=ta4, source=AYT, destination=EAS, proportion=f[0]), #fraction from East Asian to Ayta

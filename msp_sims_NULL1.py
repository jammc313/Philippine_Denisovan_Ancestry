...
# The model we are testing is NULL1B, with an admixture event from Neanderthal into the shared ancestor of all Non-Africans, a Denisovan admixture event into the ancestor of Papuans and Ayta, The difference from NULL1 is that here an additional admixture event from East Asian into Ayta
...
def set_up_demography(t78, t68, t85, t54, t10, t20, t03, t93, t34, t410, ta1, ta2, ta3, f):
    ...
    admix = [msp.MassMigration(time=ta1, source=AYT, destination=EAS, proportion=f[0]), #fraction from East Asian into to Ayta

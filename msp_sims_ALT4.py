...
# The model we are testing is ALT4B, with an admixture event from Neanderthal into the shared ancestor of all Non-Africans, a Denisovan admixture event into Papuans and another Denisovan event into Ayta, occurring at the same time. The difference from model ALT4 is that here is included a recent admixture event from East Asian into Ayta.
